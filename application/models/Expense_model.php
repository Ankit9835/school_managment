...
// The function below upate expense category //
    public function updateExpenseCategory($param2){
        $page_data = array(
            'name' => $this->input->post('name'),
            );
    ...
    public function deleteExpenseCategory($param2){
        $this->db->where('expense_category_id', $param2);
   ...
   public function updateExpense($param2){
    ...
    public function deleteExpense($param2){
        $this->db->where('payment_id', $param2);
