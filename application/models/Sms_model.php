...
class Sms_model extends CI_Model { 
    ...
    function send_sms_via_msg91($message = null , $recieverPhoneNumber = null) {
        ...
        $authKey       = $this->db->get_where('sms_settings', array('type' => 'msg91_authentication_key'))->row()->info;
        /*print_r($authkey);
        die();*/
        $senderId      = $this->db->get_where('sms_settings', array('type' => 'msg91_sender_id'))->row()->info;
        $country_code  = $this->db->get_where('sms_settings', array('type' => 'msg91_country_code'))->row()->info;
        $route         = $this->db->get_where('sms_settings', array('type' => 'msg91_route'))->row()->info;
