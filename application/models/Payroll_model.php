...
class Payroll_model extends CI_Model {
   ...
   public function insertPayrollFunction(){

     $data['payroll_code'] = substr(md5(rand(100000, 20000000)), 0,7);
     ...
     $number_of_entries = sizeOf($allowance_amounts);

     for($i = 0; $i <= $number_of_entries; $i++){

        if($allowance_types[$i] != "" && $allowance_amounts != ""){
