...
class Teacher_model extends CI_Model {
    ...
    public function updateTeacher($param2){
    ...
    public function deleteTeacher($param2){

    	/*$this->db->where('teacher_id', $param2);
    	$this->db->delete('teacher');*/

    	$teacher_id = $this->db->get_where('teacher',array('teacher_id'=>$param2))->row()->teacher_id;
        $this->db->where('bank_id',$teacher_id);
        $this->db->delete('bank');
