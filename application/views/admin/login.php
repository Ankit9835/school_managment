            ...
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="index.html">
					...
					<div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                       <select class="selectpicker m-b-20 m-r-10 form-control" data-style="btn-primary btn-outline" required>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-12 m-t-5 text-center">
                            <div class="social">
