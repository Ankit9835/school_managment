	...
	<div class="col-sm-7">
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<?php echo form_open(base_url() . 'admin/manage_profile/update', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
        ?>		
				...
				<div class="form-group"> 
					 ...
					 <div class="col-sm-12">
  		  			 <input type='file' class="form-control" name="userfile" onChange="readURL(this);" />
  		  			  <img id="blah" src="<?php echo base_url() ?>uploads/hrm_image/<?php echo $row['hrm_id'].'.jpg'; ?>" alt="test" height="200" width="200"/>
