...
<?php echo form_open(base_url() . 'admin/create_exam/insert', array('class' => 'form-horizontal form-goups-bordered validate'));?>
				...
				<thead>
                    ...
                    foreach ($exams as $key => $exam): ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/create_exam/delete/<?php echo $exam['exam_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
