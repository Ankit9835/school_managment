<div class="row">
    ...
    <div class="panel-wrapper collapse out" aria-expanded="true">
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="file" name="userfile" class="dropify">
                        </div>
                    </div>
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <?php foreach($select_library as $key => $librarian):	?>	
                               
                        <tr>
                            <td><img src="<?php echo base_url(). 'uploads/librarian_image/'. $librarian['librarian_id']. '.jpg';?>" class="img-circle" width="50" height="50"></td>
