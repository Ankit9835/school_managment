    <!-- Left navbar-header -->
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <a href="#" class="waves-effect"><img src="<?php echo base_url() . $face_file;?>" alt="user-img" width = "80" height = "40" class="img-circle"> <span class="hide-menu">
                    ...
                    <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->dashboard;
                        if($admin_role == '1'):
                    ?>
                ...
                <?php endif; ?>
                 ...
                 <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_academics;
                        if($admin_role == '1'):
                    ?>
...
<?php endif; ?>
 ...
 -->
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_employee;
                        if($admin_role == '1'):
                    ?>
        ...
        <li class="staff"> <a href="javascript:void(0);" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-angle-double-right p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('Manage Employees');?><span class="fa arrow"></span></span></a>
            ...
            <?php endif; ?>
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_student;
                        if($admin_role == '1'):
                    ?>       
    ...
    <li class="<?php if ($page_name == 'studentCategory') echo 'active'; ?> ">
     ...
     <li class="<?php if ($page_name == 'socialCategory') echo 'active'; ?> ">
                ...
                <li class="<?php if ($page_name == 'searchStudent') echo 'active'; ?> ">
                    ...
                    <li class="<?php if ($page_name == 'studentIdentityCard') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>admin/studentIdentityCard">
                        <i class="fa fa-angle-double-right p-r-10"></i>
            ...
            <?php endif; ?>
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_attendance;
                        if($admin_role == '1'):
                    ?>
                ...
                <i class="fa fa-angle-double-right p-r-10"></i>
                 ...
                 -->
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->download_page;
                        if($admin_role == '1'):
                    ?>       
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-download p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('download_page');?><span class="fa arrow"></span></span></a>
            ...
            <?php endif; ?>
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_parent;
                        if($admin_role == '1'):
                    ?>                         
        ...
        <li class=" <?php if($page_name == 'parent')echo 'active';?>">
                ...
                <?php endif; ?>
                     ...
                     <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_alumni;
                        if($admin_role == '1'):
                    ?>
        ...
        <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_loan;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-paypal p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_loan');?><span class="fa arrow"></span></span></a>
           ...
           <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->class_information;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('class_information');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
             ...
             <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_subject;
                        if($admin_role == '1'):
                    ?>
...
<li class="<?php if ($page_name == 'add_online_exam') echo 'active'; ?> ">
          ...
          <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_exam;
                        if($admin_role == '1'):
                    ?>
         ...
         <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-medkit p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_exams');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
                    ...
                    <li class="<?php if ($page_name == 'submit_exam') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>admin/create_exam">
                        <i class="fa fa-angle-double-right p-r-10"></i>
                            <span class="hide-menu"><?php echo get_phrase('add_exams'); ?></span>
                        </a>
                    </li>
...
<?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->report_card;
                        if($admin_role == '1'):
                    ?>
           ...
           <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('report_cards');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
               ...
               <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->fee_collection;
                        if($admin_role == '1'):
                    ?>
            ...
            ?>">
                ...
                <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->human_resource;
                        if($admin_role == '1'):
                    ?>
...
<li> <a href="#" class="waves-effect"<i data-icon="&#xe006;"></i> <span class="hide-menu"><i class="fa fa-university p-r-10"></i><?php echo get_phrase('payroll');?><span class="fa arrow"></span></span></a>
                  ...
                  <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->expense;
                        if($admin_role == '1'):
                    ?>
        ...
        <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_library;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-book p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_library');?><span class="fa arrow"></span></span></a>
           ...
           <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->hostel_information;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('hostel_information');?><span class="fa arrow"></span></span></a>
            ...
            ?>">
                ...
                <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->communication;
                        if($admin_role == '1'):
                    ?>
        ...
        <li class="<?php if ($page_name == 'sendSMSMessage') echo 'active'; ?> ">
               ...
               <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->transport;
                        if($admin_role == '1'):
                    ?>
        ...
        <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->system_setting;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-gears p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('system_settings');?><span class="fa arrow"></span></span></a>
            ...
            ?>">  
              ...
              <?php
                        ...
                        $admin_role = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->general_report;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('generate_reports');?><span class="fa arrow"></span></span></a>
                ...
                <li class="<?php if ($page_name == 'examMarkReport') echo 'active'; ?> ">
                 ...
                 <li class="<?php if ($page_name == 'AttendanceReport') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>report/examMarkReport">
                        <i class="fa fa-angle-double-right p-r-10"></i>
       ...
       <!--  <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-gears p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('front_end_settings');?><span class="fa arrow"></span></span></a>
        ...
        <?php
                        ...
                        $admin_role = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->level;
                        if($admin_role == '1'):
                    ?>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-cubes p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('role_managements');?><span class="fa arrow"></span></span></a>
                ...
                <?php
                        ...
                        $check_level = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->level;
                        if($check_level == '2'):
                    ?>
             ...
             <?php endif; ?>
               ...
               <li class=" <?php if($page_name == 'logout')echo 'active';?>">
