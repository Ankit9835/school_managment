<?php $class_routine = $this->db->get_where('class_routine', array('class_routine_id' => $param2))->result_array(); ?>
    ...
    <div class="box-content">
	  ...
	  <?php foreach($class_routine as $key => $routine ): ?>
        <?php echo form_open(base_url() . 'admin/class_routine/update/' . $param2 , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                    ...
                    <div class="col-sm-12">
                        <select id="class_id" name="class_id" class="form-control selectboxit" onchange="section_subject_select(this.value)">
                          <?php
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select name="day" class="form-control selectboxit">
                            ...
                            <option value="monday"  <?php if($routine['day'] == 'monday') echo 'monday'; ?>>monday</option>
                            <option value="tuesday"  <?php if($routine['day'] == 'tuesday') echo 'tuesday'; ?>>tuesday</option>
                            <option value="wednesday"  <?php if($routine['day'] == 'wednesday') echo 'wednesday'; ?>>wednesday</option>
