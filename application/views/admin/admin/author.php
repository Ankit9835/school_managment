<div class="row">
                ...
                <?php echo form_open(base_url(). 'admin/author/insert', array('class' => 'form-horizontal form-goups-bordered validate')); ?>
                    ...
                    <div class="col-sm-12">
                           ...
                           <div class="form-group">
                                  <button type="submit" class="btn btn-block btn-info btn-rounded btn-sm "><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_author');?></button>
							</div>
                            <?php echo form_close(); ?>
