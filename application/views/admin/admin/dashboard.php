<?php
    ...
    $select_role = array('admin_id' => $this->session->userdata('login_user_id'),
    'dashboard' => '1',
    'manage_academics' => '1',
    'manage_employee' => '1',
    'manage_student' => '1',
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Teacher'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('accountant'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4>
                                        ...
                                        $att_data = array('date' => date('Y-m-d'), 'status' => '1');

                                        $get_attendance = $this->db->get_where('attendance', $att_data);
                                        $num_rows = $get_attendance->num_rows();
                                        echo $num_rows; 
...
amCharts
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Recently Added Teacher</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $teacher_data = $this->crud_model->list_all_teacher();
                                        foreach ($teacher_data as $key => $teacher):
                                            
                                        
                                    ?>
                                        <tr>
                                            <td><img src = "<?php echo  $teacher['face_file'] ?>"></td>
                    ...
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Recently Added Students</h3>
                            ...
                            <div class="table-responsive">
                                 <table class="table">
                                    ...
                                    <?php
                                        $student_data = $this->crud_model->list_all_student();
                                        foreach ($student_data as $key => $student):
                                            
                                        
                                    ?>
                                        <tr>
                                            <td><img src = "<?php echo  $student['face_file'] ?>"></td>
