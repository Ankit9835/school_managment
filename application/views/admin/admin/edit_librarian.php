    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('Edit Librarian');?></div>
                    ...
                    <div class="col-sm-12">
                            ...
                            <img src="<?php echo base_url(). 'uploads/librarian_image/' . $librarian['librarian_id'] . '.jpg'  ?>" class="img-circle" width="30" height="30">
                        </div>
                    </div>
