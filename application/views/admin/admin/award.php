...
<?php echo form_open(site_url('admin/award/insert'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                   ...
                   <label class="col-md-12" for="example-text"><?php echo get_phrase('employee'); ?></label>
                    ...
                    <div class="col-sm-12">
                        <select name="user_id" class="form-control select2" required>
                            ...
                            ?>
                                <option value="admin-<?php echo $admin['admin_id'] ?>">
                                    <?php echo $admin['name']; ?>
                                </option>
                            ...
                            ?>
                                <option value="teacher-<?php echo $teacher['teacher_id'] ?>">
                            ...
                            <?php 
                                $hrm = $this->db->get('hrm')->result_array();
                                foreach ($hrm as $key => $hrm):
                            ?>
                                <option value="hrm-<?php echo $hrm['hrm_id'] ?>">
                                    <?php echo $hrm['name']; ?>
                                </option>
                            ...
                            ?>
                                <option value="accountant-<?php echo $accountant['accountant_id'] ?>">
                            ...
                            ?>
                                <option value="parent-<?php echo $parent['parent_id'] ?>">
                            ...
                            <?php 
                                $hostel = $this->db->get('hostel')->result_array();
                                foreach ($hostel as $key => $hostel):
                            ?>
                                <option value="hostel-<?php echo $hostel['hostel_id'] ?>">
                            ...
                            ?>
                                <option value="librarian-<?php echo $librarian['librarian_id'] ?>">
                                    <?php echo $librarian['name']; ?>
                                </option>
