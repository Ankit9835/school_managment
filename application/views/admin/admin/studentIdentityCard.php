<div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('select_class');?></div>
                ...
                <div id="data">
                <?php include 'showStudentIdcard.php';?>
                </div>
	...
	$(document).ready(function() {
		...
		$('#find').on('click', function() 
		{
           ...
           $.toast({
			...
			$.ajax({
				url: '<?php echo site_url('admin/getStudentIdCard/');?>' + class_id
