<div class="row">
                ...
                <?php echo form_open(base_url(). 'admin/publisher/insert', array('class' => 'form-horizontal form-goups-bordered validate')); ?>
                    ...
                    <div class="col-sm-12">
                                    ...
                                    <input name="publisher_name" type="text" class="form-control"/ required>
                                </div>
                            </div>
