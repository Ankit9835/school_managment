...
<!----CREATION FORM STARTS---->
			...
			<!----CREATION FORM ENDS-->
				    ...
				    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_vechile/<?php echo $vehicle['vehicle_id'];?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-pencil"></i></button></a>
