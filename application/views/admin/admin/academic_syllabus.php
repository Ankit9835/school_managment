...
<!----CREATION FORM STARTS---->
                	...
                	<?php echo form_open(base_url() . 'admin/academic_syllabus/insert' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
