...
<div class="panel panel-info">
                ...
                <?php echo form_open(base_url() . 'admin/new_student/insert/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				<div class="form-group"> 
					 <div class="col-sm-12">
  		  			  <input type='file' name="userfile" onChange="readURL(this);" / required style="color:red">
