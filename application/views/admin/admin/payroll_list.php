<?php echo form_open(base_url() . 'admin/payroll_list/filter'); ?>
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <?php $list_years = array('2020', '2021', '2022', '2023', '2024', '2025', '2026');
...
<hr>
    ...
    <table class="table table-bordered">
                        ...
                        <div>
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 15%; text-align: right;"> :<?php echo $user->joining_salary; ?> </td>
                                    <td style="text-align: right;"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;"><?php echo get_phrase('total_allowance'); ?></td>
                                    <td style="width: 15%; text-align: right;"> :<?php echo $total_allowance; ?> </td>
                                    <td style="text-align: right;"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;"><?php echo get_phrase('total_deduction'); ?></td>
                                    <td style="width: 15%; text-align: right;"> :<?php echo $total_deduction; ?> </td>
                                    <td style="text-align: right;"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%; text-align: right;"> :<?php echo $net_salary; ?> </td>
                                    <td style="text-align: right;"></td>
                                </tr>
                            </table>
                        </div>
     ...
     <?php
        if($row['status'] == 0){
     ?>
      <a href="<?php echo base_url(); ?>admin/payroll_list/mark_paid/<?php echo $row['payroll_id'] ?>" class="btn btn-primary btn-rounded btn-sm" style="color:#fff"><i class="fa fa-check"></i> <?php echo get_phrase('mark_as_paid'); ?></a>
      <?php } ?>
                    </td>
                </tr>
