        ...
        <div class="panel panel-info">
           	<div class="panel-heading">
					 <?php echo get_phrase('Manage Language'); ?>
						...
						<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_language_add/');">
						<button type="button" class="btn btn-info btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_language');?>
						</button></a>
						
						<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_phrase_add/');">
