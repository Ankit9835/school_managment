  ...
  <div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body table-responsive">
<?php echo form_open(base_url() . 'admin/student_payment/take_payment/'.$invoice['invoice_id'], array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>

				<div class="form-group"> 
					 <label class="col-sm-12"><?php echo get_phrase('total_amount');?>*</label>        
					 <div class="col-sm-12">
		                    <input type="text" class="form-control" value="<?php echo $invoice['amount'];?>" readonly/>
		                </div>
		            </div>
		           ...
		           <div class="form-group"> 
					 ...
					 <div class="col-sm-12">
		                    <input type="text" class="form-control" name="amount_paid" value="<?php echo $invoice['amount_paid'];?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group"> 
					 ...
					 <div class="col-sm-12">
		                    <input type="text" class="form-control" value="<?php echo $invoice['due'];?>" readonly/>
		                </div>
		            </div>
		...
		<input class="form-control m-r-10" name="timestamp" type="date" value="<?php echo date('Y-m-d') ?>" id="example-date-input" required>
                    ...
                    <input type="hidden" name="title" value="<?php echo $invoice['title'];?>">
                    <input type="hidden" name="description" value="<?php echo $invoice['description'];?>">

		            <div class="form-group">
                           <div class="col-sm-5 col-sm-offset-3">
		                    <button type="submit" class="btn btn-info btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('accept_payment');?></button>
		                </div>
		            </div>
