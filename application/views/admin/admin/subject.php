...
<!----CREATION FORM STARTS---->
                    ...
                    <?php echo form_open(base_url() . 'subject/subject/insert' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            ...
            <!----CREATION FORM ENDS-->
                ...
                <div id="data">
                <?php include 'displSubjectClasswise.php';?>
                </div>
       ...
       // $('#class_id').select2();
        $('#find').on('click', function() 
        {
           ...
           $.toast({
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>subject/getSubjectByClasswise/' + class_id
