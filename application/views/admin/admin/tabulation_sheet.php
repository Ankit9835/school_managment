...
<div class="row">
  ...
  foreach ($select_subject as $key => $subject):
    ...
    foreach ($update_subject_marks as $key => $update_marks):
      ...
      $all_sum_score = $update_marks['class_score1'] + $update_marks['class_score2'] + $update_marks['class_score3'] + $update_marks['exam_score'];
...
endforeach;
 ...
 ?>
        ...
        <a href =  "<?php echo base_url(). 'admin/print_mass_report_card/'. $class_id . '/' . $exam_id; ?>" class="btn btn-success btn-rounded btn-block text-white"> Mass Report </a>
