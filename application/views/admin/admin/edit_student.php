...
<div class="panel panel-info">
                ...
                <?php echo form_open(base_url() . 'admin/new_student/update/' .$student['student_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
