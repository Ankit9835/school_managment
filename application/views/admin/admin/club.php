...
<div class="panel-wrapper collapse in" aria-expanded="true">
				...
				<thead>
                    ...
                    <tbody>
                        <?php $count = 1; foreach($select_club as $key => $select_club) {
                            # code...
                        } ?>
                        <tr>
                            <td> <?php echo $count++; ?> </td>
                            <td> <?php echo $select_club['club_name']; ?> </td>
                            <td><?php echo $select_club['description']; ?></td>
							<td><?php echo $select_club['date']; ?></td>
							
							<td>

                             <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_club/<?php echo $select_club['club_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url();?>admin/club/delete/<?php echo $select_club['club_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
