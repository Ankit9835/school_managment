...
<table id="example" class="table display">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo base_url(). 'uploads/student_image/' .$student['student_id'] . '.jpg' ?>" class="img-circle" width="30"></td>
                            <td><?php echo $student['roll'] ?></td>
                            <td><?php echo $student['name'] ?></td>
                            <td><?php echo $this->db->get_where('class', array('class_id' => $student['class_id']))->row()->name; ?></td>
                     ...
                     <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/studentIdCard/<?php echo $student['student_id'] ?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-hospital-o"></i></a>
