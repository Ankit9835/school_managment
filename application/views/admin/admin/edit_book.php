...
<!----CREATION FORM STARTS---->
	...
	<div class="form-group">
        ...
        <img src="<?php echo base_url() ?>uploads/book_image/<?php echo $book['book_id']. '.jpg' ?>" height="30px" weight="30px" class="img-circle">
        </div>
    </div>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-info btn-sm btn-block btn-rounded"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_book');?></button>
    </div>
<?php echo form_close();?>            
