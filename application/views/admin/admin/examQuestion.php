<div class="row">
                ...
                <?php echo form_open(base_url().'admin/examQuestion/insert' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    ...
    <?php $counter = 1; $exam_questions = $this->db->get('exam_question')->result_array();
            ...
            <tr>
                ...
                <td>
                <a href="<?php echo base_url() ?>uploads/exam_question/<?php echo $exam_question['file_name']; ?>"><button type="button" class="btn btn-info btn-circle btn-xs" ><i class="fa fa-download"></i></button></a>
