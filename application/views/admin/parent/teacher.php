            ...
            <div class="row">
                    ...
                    <tbody>
                    <?php foreach($student_teacher as $key => $teacher){ ?>
                        <tr>
                            <td><img src="<?php echo base_url() ?>uploads/teacher_image/<?php echo $teacher['teacher_id'].'.jpg' ?>" class="img-circle" width="30px"></td>
