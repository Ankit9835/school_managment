...
class Parents extends CI_Controller { 
    ...
    if ($this->session->userdata('admin_login') == 1) redirect(base_url() . 'parent/dashboard', 'refresh');
    }
      /************* / default functin, redirects to login page if no admin logged in yet***/
    ...
    if ($param1 == 'update') {
        ...
        redirect(base_url() . 'parent/manage_profile', 'refresh');
    ...
    function class_mate (){
        ...
        $page_data['select_student_class_id']  = $parent_profile->class_id;  
    ...
    public function testimony($param1 = null, $param2 = null, $param3 = null){

            if($param1 == 'submit_testimony'){
               $this->crud_model->submitTestimony();
            $this->session->set_flashdata('flash_message', get_phrase('Data Updated successfully'));
            redirect(base_url(). 'parents/testimony', 'refresh');
            }
