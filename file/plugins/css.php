...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>file/images/favicon.png">
   ...
   <link href="<?php echo base_url() ?>file/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>file/plugins/bower_components/bootstrap-extension/css/bootstrap-extension.css" rel="stylesheet">
    <!-- Menu CSS -->
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url() ?>file/css/colors/megna.css" id="theme" rel="stylesheet">
    <link href="<?php echo base_url();?>file/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
